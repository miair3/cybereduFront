...
const videoLessons = [
  {
    id: 201,
    title: "Начало игры в PUBG — Урок №1",
    url: "https://www.youtube.com/embed/VG_5faFC0ho?si=Kb_ESJ0rb3BJJRbm",
  },
  {
    id: 202,
    title: "Лучшие советы по стрельбе — Урок №2",
    url: "https://www.youtube.com/embed/_6kxi1kKzgY?si=UwNSo80YawJRbwNg",
  },
  {
    id: 203,
    title: "Тактика выживания — Урок №3",
    url: "https://www.youtube.com/embed/4QBV3yX4e_U?si=AVThLvuXUY-x72OVz",
  },
];
    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1">
          <div className="rounded-xl overflow-hidden shadow-xl mb-4 border border-orange-700">
            <iframe
              width="100%"
              height="440"
        ...
        <div className="w-full lg:w-1/3 bg-[#1f1f24] p-4 rounded-xl shadow-lg border border-gray-700">
          <h4 className="text-lg font-bold mb-4 text-orange-300">Комментарии</h4>
          ...
          <form onSubmit={handleCommentSubmit} className="mb-4">
            ...
            <button
              type="submit"
              className="mt-2 w-full px-4 py-2 bg-orange-500 hover:bg-orange-600 rounded"
