...
const videoLessons = [
  {
    id: 301,
    title: "Основы GTA V — Урок №1",
    url: "https://www.youtube.com/embed/9_0ezkc2EYk?si=MRSAZMudqfStPjfi",
  },
  {
    id: 302,
    title: "Как заработать деньги в GTA Online — Урок №2",
    url: "https://www.youtube.com/embed/vbJNvSYoCJ4?si=BDgF4t1e0JSz0BE2",
  },
  {
    id: 303,
    title: "Лучшие трюки и лайфхаки — Урок №3",
    url: "https://www.youtube.com/embed/XjRrKV5_jnI?si=lAhIeMgMNDUotMui",
  },
];
    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1">
          <div className="rounded-xl overflow-hidden shadow-xl mb-4 border border-green-700">
            <iframe
              width="100%"
              height="440"
        ...
        <div className="w-full lg:w-1/3 bg-[#1f1f24] p-4 rounded-xl shadow-lg border border-gray-700">
          <h4 className="text-lg font-bold mb-4 text-green-300">Комментарии</h4>
          ...
          <form onSubmit={handleCommentSubmit} className="mb-4">
            ...
            <button
              type="submit"
              className="mt-2 w-full px-4 py-2 bg-green-500 hover:bg-green-600 rounded"
