...
const CallOfDutyPage = () => {
  ...
  // Загружаем данные о лайках и дизлайках
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f0b] text-white p-6">
      <h2 className="text-3xl font-bold text-green-400 mb-6">
        Курс по Call of Duty
      </h2>
      ...
      <div className="mt-10 border-t border-gray-700 pt-6 flex flex-wrap justify-center gap-4">
        ...
        <button className="px-6 py-3 bg-green-600 hover:bg-green-700 rounded-xl text-white text-sm">
