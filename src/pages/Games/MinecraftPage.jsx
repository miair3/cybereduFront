...
const videoLessons = [
  {
    id: 1,
    title: "Как выжить в Minecraft — Урок №1",
    url: "https://www.youtube.com/embed/MmB9b5njVbA",
  },
  {
    id: 2,
    title: "Как построить дом — Урок №2",
    url: "https://www.youtube.com/embed/Mk787BE_LOc?si=sJTBGqH7w0_JQM3o",
  },
  {
    id: 3,
    title: "Как найти алмазы — Урок №3",
    url: "https://www.youtube.com/embed/AZZGTDdRFzI?si=9xPfvuLWZ8g3vSJT",
  },
];

const MinecraftPage = () => {
  const [selectedLesson, setSelectedLesson] = useState(videoLessons[0]);
  const [likeStatus, setLikeStatus] = useState(null); // null, 'like' или 'dislike'
  ...
  // Загружаем данные о лайках при монтировании и смене урока
  useEffect(() => {
    const fetchLessonData = async () => {
      try {
        ...
        // Проверяем, поставил ли пользователь уже лайк/дизлайк
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              disabled={!token}
              title={!token ? "Войдите, чтобы оценить" : ""}
            >
              👍 {likesCount}
            </button>
            <button
