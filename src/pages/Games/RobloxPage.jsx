    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1">
          <div className="rounded-xl overflow-hidden shadow-xl mb-4 border border-yellow-700">
            <iframe
              width="100%"
              height="440"
        ...
        <div className="w-full lg:w-1/3 bg-[#1f1f24] p-4 rounded-xl shadow-lg border border-gray-700">
          <h4 className="text-lg font-bold mb-4 text-yellow-300">Комментарии</h4>
          ...
          <form onSubmit={handleCommentSubmit} className="mb-4">
            ...
            <button
              type="submit"
              className="mt-2 w-full px-4 py-2 bg-yellow-500 hover:bg-yellow-600 rounded"
